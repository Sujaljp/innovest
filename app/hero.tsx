...
const Hero = () => {
  return (
    <div className="flex flex-col space-y-4 p-16 pt-6 pb-6 text-primary-foreground">
            <div className="hero h-96 flex justify-center items-center mt-4 ">
              <div className=" space-y-4 pt-6 w-1/2  text-1xl m-auto text-center ">
                <h2 className="text-4xl font-bold tracking-tight">Welcome to Innovest</h2>
                <div className="">
            ...
            <i className="uil uil-angle-down text-6xl m-auto pt-4"></i>
          </div>
  )
}
